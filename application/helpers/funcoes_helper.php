...
if(!function_exists('config_uploadMaterial')):
	//define as  configurações para upload de imagens/arquivos
	function config_uploadMaterial($path='./assets/material/', $types='jpg|png' , $size=2048){
		$config['upload_path']= $path; //array de configurações, path de upolad
		$config['allowed_types']=$types;//tipos de upload
		$config['max_size'] = $size;//maximo tamanho de arquivo
		return $config;
	}
endif;
